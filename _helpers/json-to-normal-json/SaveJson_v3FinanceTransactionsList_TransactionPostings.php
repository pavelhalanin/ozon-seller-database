...
class SaveJson_v3FinanceTransactionsList_TransactionPostings {
    static function main() {
        ...
        foreach ($array as $element) {
            ...
            $data['operation_id'] = $element['operation_id'];
            $element = $element['posting'];

            $str_fields = ['delivery_schema', 'order_date', 'posting_number', 'warehouse_id'];
        ...
        $JSON = $result_array;
        $FILE_PATH = "$HOME/database/OZN_v3FinanceTransactionsList_TransactionPostings.json";

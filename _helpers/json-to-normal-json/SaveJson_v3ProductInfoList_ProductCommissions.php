...
class SaveJson_v3ProductInfoList_ProductCommissions {
    static function main() {
        global $HOME;
        $INPUT_FILE = "$HOME/data/v3_product_info_list.json";
        $OUTPUT_FILE = "$HOME/database/OZN_v3ProductInfoList_ProductCommissions.json";
        ...
        for ($i = 0; $i < count($array); $i++) {
            ...
            for ($j = 0; $j < count($list); $j++) {
                ...
                $str_fields = ['delivery_amount', 'percent', 'return_amount', 'sale_schema', 'value'];

...
class SaveJson_v3ProductInfoList_ProductVisabilityDetails {
    static function main() {
        global $HOME;
        $INPUT_FILE = "$HOME/data/v3_product_info_list.json";
        $OUTPUT_FILE = "$HOME/database/OZN_v3ProductInfoList_ProductVisabilityDetails.json";
        ...
        for ($i = 0; $i < count($array); $i++) {
            ...
            $element = $element['visibility_details'];
            ...
            $boolean_fields = ['has_price', 'has_stock'];
